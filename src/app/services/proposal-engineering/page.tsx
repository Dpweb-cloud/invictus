    ...
    <div className="flex flex-col bg-background min-h-screen">
      ...
      <section className="py-16 md:py-24 bg-white dark:bg-[#0A0E14]">
        <StaggerWrapper className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <FadeUpBox>
            <h3 className="text-2xl font-heading font-bold text-[#0A192F] dark:text-white mb-6">
            ...
            <ul className="space-y-4 mb-12">
              {[
                ...
                <li key={idx} className="flex items-start p-4 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-200/70 dark:border-white/10">
                  <CheckCircle className="h-6 w-6 text-[#108A00] dark:text-[#4ADE80] mr-4 shrink-0 mt-0.5" />
