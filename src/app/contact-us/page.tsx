      ...
      <section className="py-16 md:py-24 bg-white dark:bg-[#04101C]">
        <StaggerWrapper className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <FadeUpBox>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start p-6 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-200/70 dark:border-white/10">
                  <div className="p-3 bg-[#071A2B] text-[#108A00] rounded-2xl mr-4 flex-shrink-0 border border-[#0B5CAD]/30">
                    <MapPin className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="font-bold text-[#071A2B] dark:text-white mb-1 text-base">Headquarters &amp; Office</h3>
                ...
                {/* Phone */}
                <div className="flex items-start p-6 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-200/70 dark:border-white/10">
                  <div className="p-3 bg-[#108A00]/10 text-[#108A00] rounded-2xl mr-4 flex-shrink-0">
                    <Phone className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="font-bold text-[#071A2B] dark:text-white mb-1 text-base">Direct Line</h3>
                ...
                <div className="flex items-start p-6 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-200/70 dark:border-white/10">
                  ...
                  <div>
                    <h3 className="font-bold text-[#071A2B] dark:text-white mb-1 text-base">WhatsApp Support</h3>
                    <p className="text-gray-600 dark:text-gray-300 text-sm">
                ...
                <div className="flex items-start p-6 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-200/70 dark:border-white/10">
                  ...
                  <div>
                    <h3 className="font-bold text-[#071A2B] dark:text-white mb-1 text-base">Email Enquiries</h3>
                    <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <FadeUpBox delay={0.2}>
              <div className="bg-white dark:bg-[#071A2B] rounded-3xl border border-gray-200/80 dark:border-white/10 shadow-xl p-8 lg:p-10">
                <h3 className="text-2xl font-bold text-[#071A2B] dark:text-white mb-6">Send an Enquiry</h3>
                
                {status === "success" ? (
                  <div className="p-6 bg-[#108A00]/10 border border-[#108A00]/30 rounded-2xl text-[#108A00] text-center">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                      <label htmlFor="name" className="block text-sm font-bold text-[#071A2B] dark:text-white mb-2">Full Name *</label>
                    ...
                    <div>
                      <label htmlFor="email" className="block text-sm font-bold text-[#071A2B] dark:text-white mb-2">Email Address *</label>
                    ...
                    <div>
                      <label htmlFor="subject" className="block text-sm font-bold text-[#071A2B] dark:text-white mb-2">Subject / Scope</label>
                    ...
                    <div>
                      <label htmlFor="message" className="block text-sm font-bold text-[#071A2B] dark:text-white mb-2">Project Message *</label>
                    ...
                    <button 
                      ...
                      className="w-full rounded-2xl bg-[#108A00] px-8 py-4 text-base font-bold text-white shadow-lg shadow-[#108A00]/25 hover:bg-[#0D7000] hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-70 disabled:hover:translate-y-0"
                    >
