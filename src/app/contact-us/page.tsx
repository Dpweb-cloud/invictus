                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+919890300211" className="hover:text-brand-accent transition-colors">+91 9890300211</a>
                    </p>
                  </div>
                </div>

                <div className="flex items-start">
                  <div className="p-4 bg-[#25D366]/10 rounded-xl text-[#25D366] mr-4">
                  ...
                  <div>
                    <h3 className="font-bold text-brand-primary-dark mb-1">WhatsApp</h3>
                    <p className="text-gray-600">
                      <a href="https://wa.me/919890300211" target="_blank" rel="noopener noreferrer" className="hover:text-[#25D366] transition-colors font-medium">
                        +91 9890300211
                      </a>
                    </p>
                  </div>
